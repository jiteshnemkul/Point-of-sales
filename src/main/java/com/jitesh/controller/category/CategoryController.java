...
private categoryService cat;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        categoryTable.setItems(cat.CATEGORYLIST);
    ...
    private void filterData() {
        FilteredList<Category> searchedData = new FilteredList<>(cat.CATEGORYLIST, e -> true);
    ...
    private void loadData() {
        ...
        if (!cat.CATEGORYLIST.isEmpty()) {
            cat.CATEGORYLIST.clear();
        }
        cat.CATEGORYLIST.addAll(cat.getCategories());
    }
    ...
    public void deleteAction(ActionEvent event) {
        ...
        if (result.get() == ButtonType.OK) {
            ...
            cat.delete(selectedCategory);
            cat.CATEGORYLIST.remove(selectedCategory);
        }
